...
public class GoogleReaderTest {
	...
	public void testAuth() throws FileNotFoundException, IOException, AuthenticationException, GoogleReaderException {
		...
		List<ItemDescriptor> itemDesList = googleReader.getFeedItems("feed/http://echohfut.javaeye.com/rss");
		//System.out.println(googleReader.getFeedItems("feed/http://echohfut.javaeye.com/rss"));
